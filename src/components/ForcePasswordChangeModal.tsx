...
export default function ForcePasswordChangeModal() {
  ...
  return (
    <div style={overlayStyle}>
      ...
      >
        <div style={{ background: "linear-gradient(135deg,#1E3A5F,#2563EB)", padding: "18px 20px 14px" }}>
          ...
          <p style={{ fontSize: 12, color: "#BFDBFE", margin: 0, lineHeight: 1.45 }}>
        ...
        <div style={{ padding: "18px 20px 20px" }}>
          ...
          <button
            ...
            style={{
              ...
              borderRadius: 12,
              border: "none",
              background: (loading || !form.newPass || form.newPass !== form.confirmPass || form.newPass.length < 8) ? "#E2E8F0" : "linear-gradient(135deg,#2563EB,#1D4ED8)",

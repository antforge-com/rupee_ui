              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBlockEnd: 12 }}>
                ...
                <div style={{ display: "flex", gap: 8 }}>
                  <button
                    ...
                    style={{ background: "#EFF6FF", color: "#2563EB", border: "none", borderRadius: 6, inlineSize: 28, blockSize: 28, display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer" }}
                    title="Edit Plan"
                  >
                    <Edit2 size={14} />
                  </button>
                  <button
                    ...
                    style={{ background: "#FEF2F2", color: "#DC2626", border: "none", borderRadius: 6, inlineSize: 28, blockSize: 28, display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer" }}
                    title="Delete Plan"
                  >
                    <Trash2 size={14} />
                  </button>
            ...
            <form onSubmit={handleSubmit} style={{ padding: "24px" }}>
              ...
              <div style={{ marginBlockStart: 24, display: "flex", justifyContent: "flex-end", gap: 12 }}>
                ...
                <button
                  ...
                  style={{ padding: "10px 20px", background: "#2563EB", color: "#fff", border: "none", borderRadius: 8, fontSize: 13, fontWeight: 700, cursor: formSubmitting ? "not-allowed" : "pointer", display: "flex", alignItems: "center", gap: 8 }}
                >
                  {formSubmitting && (

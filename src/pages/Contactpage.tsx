    ...
    <div style={{ minHeight: "100vh", background: "#F8FAFC", fontFamily: "Inter, system-ui, sans-serif" }}>
      ...
      <header style={{
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto", height: 64, display: "flex", alignItems: "center", gap: 16 }}>
          ...
          <div style={{ fontSize: 16, fontWeight: 800, color: "#1E3A5F", letterSpacing: "0.04em" }}>
            MEET THE <span style={{ color: "#2563EB" }}>MASTERS</span>
          </div>
        </div>
      </header>
      ...
      <main style={{ maxWidth: 1100, margin: "0 auto", padding: "48px 24px" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 48 }}>
          <div style={{
            ...
            fontWeight: 700, color: "#2563EB", marginBottom: 16,
          }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1.6fr", gap: 32, alignItems: "start" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            {[
              {
                icon: <Mail size={20} color="#2563EB" strokeWidth={1.8} />,
                label: "Email Us",
                value: "support@meetthemasters.in",
                sub: "We reply within 24 hours",
              },
              {
                icon: <Phone size={20} color="#2563EB" strokeWidth={1.8} />,
                label: "Call Us",
                value: "+91 99999 99999",
                sub: "Mon – Sat, 9 AM – 6 PM IST",
              },
              {
                icon: <MapPin size={20} color="#2563EB" strokeWidth={1.8} />,
                label: "Office",
            ...
            {success ? (
              <div style={{ textAlign: "center", padding: "40px 0" }}>
                ...
                <div style={{ display: "flex", gap: 12, justifyContent: "center" }}>
                  ...
                  <button
                    onClick={() => navigate("/")}
                    style={{ padding: "10px 22px", borderRadius: 10, border: "none", background: "linear-gradient(135deg,#2563EB,#1D4ED8)", color: "#fff", fontSize: 14, fontWeight: 700, cursor: "pointer" }}
                  >
                    Back to Home
                  </button>
                </div>

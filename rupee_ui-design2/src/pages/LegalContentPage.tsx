    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <div style={{ display: "inline-flex", alignItems: "center", background: "rgba(255,255,255,0.95)", borderRadius: 10, padding: "5px 10px" }}>
              <img src={headerLogoImg} alt="Meet The Masters" style={{ height: 42, width: "auto", maxWidth: 260, objectFit: "contain", display: "block" }} />
            </div>
          ...
          <div style={{ padding: 28 }}>
            {loading ? (
              <div style={{ textAlign: "center", padding: "28px 0", color: "#475569" }}>
                <img src={logoImg} alt="Meet The Masters" style={{ width: 54, height: "auto", display: "block", margin: "0 auto 12px", animation: "mtmPulse 1.8s ease-in-out infinite" }} />
                <div style={{ fontSize: 15, lineHeight: 1.7 }}>Loading the latest saved content...</div>
              </div>
            ) : content.trim() ? (
              <pre
                style={{

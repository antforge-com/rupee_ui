/**
 * TicketSummaryChart.tsx
 * ─────────────────────────────────────────────────────────────────────────────
 * Module 6 — Daily / Weekly Summary Bar Charts
 *
 * Features:
 *   • Toggle between Daily (last 7 days) and Weekly (last 8 weeks) view
 *   • X-axis = time period (days/weeks)
 *   • Y-axis = ticket count
 *   • Group-by selector: Consultant | Category | Status
 *   • Fully dynamic — reads from live ticket data passed via props
 *   • Responsive layout, same color palette as AdminPage
 * ─────────────────────────────────────────────────────────────────────────────
 */
      ...
      <div style={{
        ...
        <div>
          ...
          <p style={{ margin: "4px 0 0", fontSize: 12, color: "#64748B" }}>
            ...
            <strong style={{ color: "#2563EB", textTransform: "capitalize" }}>{groupBy}</strong>
          </p>
        </div>
              ...
              <button
                ...
                style={{
                  ...
                  background: viewMode === v
                    ? "linear-gradient(135deg,#1E3A5F,#2563EB)" : "transparent",
            ...
            <ResponsiveContainer width="100%" height={300}>
              ...
              >
                ...
                <Tooltip
                  ...
                  labelStyle={{ fontWeight: 700, marginBottom: 6, color: "#BFDBFE" }}
  ...
  switch (groupBy) {
    ...
    case "consultant":
      return (
        t.consultantName ||
        (t.agentName) ||
        (t.consultantId ? nameMap[t.consultantId] || `Consultant #${t.consultantId}` : null) ||
        "Unassigned"
      );
